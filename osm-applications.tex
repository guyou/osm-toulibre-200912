...
\begin{frame}{Calcul d'itinéraire}

En vélo

\includegraphics[width=\textwidth]{figures/800px-CloudMade_Bicycle_Routing}
...
\includegraphics[width=0.8\textwidth]{figures/TerpNavPedestrianMappingSystem}

\end{frame}

\begin{frame}{Calcul d'itinéraire}

... voire à l'intérieur des bâtiments.

\includegraphics[width=0.8\textwidth]{figures/Inhouserouting}
